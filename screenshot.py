r"""
CYD-Crypto-Tracker screenshot capture.
...
Examples:
  ...
  python screenshot.py COM10 current
  python screenshot.py 1 ScreenShots\screen_crypto.bmp

Screens: current, 0/p1, 1/p2, 2/p3, 3/p4, 4/p5, settings/5
Default port: auto-detect or COM10
"""
...
SCREENS = {
    "0":  ("Page 1", b"0", "ScreenShots\\screen_page1.bmp"),
    "p1": ("Page 1", b"0", "ScreenShots\\screen_page1.bmp"),
    "1":  ("Page 2", b"1", "ScreenShots\\screen_page2.bmp"),
    "p2": ("Page 2", b"1", "ScreenShots\\screen_page2.bmp"),
    "2":  ("Page 3", b"2", "ScreenShots\\screen_page3.bmp"),
    "p3": ("Page 3", b"2", "ScreenShots\\screen_page3.bmp"),
    "3":  ("Page 4", b"3", "ScreenShots\\screen_page4.bmp"),
    "p4": ("Page 4", b"3", "ScreenShots\\screen_page4.bmp"),
    "4":  ("Page 5", b"4", "ScreenShots\\screen_page5.bmp"),
...
def normalize_screen(value):
    ...
    if key not in SCREENS:
        valid = "current, 0, 1, 2, 3, 4, 5, p1-p5, settings"
...
def ask_interactive():
    print("CYD-Crypto-Tracker Screenshot")
